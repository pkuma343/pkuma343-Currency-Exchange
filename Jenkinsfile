...
stage('Docker build') {
bat 'docker build -t pkuma343/currency-exchange-os:v1 -f Dockerfile .'
}
stage('Push Image') {
...
bat 'docker push pkuma343/currency-exchange-os:v1'
}
...
bat "C:\\Softwares\\openshift-origin-client-tools-v1.5.1-7b451fc-windows\\oc.exe login --token=${ocToken} --server=https://api.ca-central-1.starter.openshift-online.com:6443"
